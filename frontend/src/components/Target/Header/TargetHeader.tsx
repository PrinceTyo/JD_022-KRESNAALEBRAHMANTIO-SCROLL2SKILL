...
export const TargetHeader = ({ onAdd }: TargetHeaderProps) => {
      ...
      <div className="flex flex-col md:flex-row items-center justify-between h-full px-4 md:px-8 py-4 gap-4">
        <div className="space-y-4 w-full md:w-auto">
          <div>
            ...
            <p className="text-accent">Let's finish your target today!</p>
          </div>
          <div
          ...
          >
            ...
            <button className="text-md font-bold">Add Target</button>
          </div>
        </div>
